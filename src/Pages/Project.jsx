    ...
    return(
        <div>
            <div className="mt-[6rem] px-8">
                <h1 className="text-[2.8rem] text-[#fff] leading-[3rem]">My <Flickering initial={"P"} chars={["P", "#", "^"]} mainPause={"1200"} subPause={"200"}/>
                    ...
                    <p className="w-[50%] text-[16px] pt-10 text-[#777]">
                    ...
                    <div className="w-[50%] mt-10 flex gap-[4rem]">
